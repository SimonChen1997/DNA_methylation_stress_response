...
differntial_position_replicate <- function(differential_methyl_from, pileup_position, specified_region){
  ...
  differential_methyl_region_position_summary <- differential_methyl_region_position %>%
    group_by(chrom, start, end, strand, modified_base_code, condition, phase, id, locus_tag, symbol) %>%
...
differntial_position_replicate_none_regulatory <- function(differential_methyl_from, pileup_position, specified_region){
  ...
  differential_methyl_region_position_summary <- differential_methyl_region_position %>%
    group_by(chrom, start, end, strand, modified_base_code, condition, phase) %>%
    summarise(mean_modified_fraction = mean(100*modified_number/valid_coverage), 
              sd_modified_fraction = sd(100*modified_number/valid_coverage), 
              region = specified_region, .groups = "drop")
...
write_tsv(ecoli_position_clean_differntial, 
          file=glue("{out_dir}/{a_group}_{b_group}_{con}_position_clean_differntial.tsv"))
...
write_tsv(ecoli_position_clean_differntial_nonregulatory, 
          file=glue("{out_dir}/{a_group}_{b_group}_{con}_position_clean_differntial_nonregulatory.tsv"))
...
write_tsv(gene_body_promoter_position_differntial_combine, 
          file=glue("{out_dir}/{a_group}_{b_group}_{con}_diffferential_metyhl_position_gene_summary.tsv"))
...
write_tsv(none_regulatory_position_differntial_combine, 
          file=glue("{out_dir}/{a_group}_{b_group}_{con}_diffferential_metyhl_none_regulatory_position_summary.tsv"))
...
write_lines(gene_id_promoter_m6A, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_list_promoter_m6A.tsv"))
write_lines(gene_symbol_promoter_m6A, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_symbol_list_promoter_m6A.tsv"))
...
write_lines(gene_id_gene_body_m6A, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_list_gene_body_m6A.tsv"))
write_lines(gene_symbol_gene_body_m6A, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_symbol_list_gene_body_m6A.tsv"))
...
write_lines(gene_id_promoter_m4C, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_list_promoter_m4C.tsv"))
write_lines(gene_symbol_promoter_m4C, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_symbol_list_promoter_m4C.tsv"))
...
write_lines(gene_id_gene_body_m4C, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_list_gene_body_m4C.tsv"))
write_lines(gene_symbol_gene_body_m4C, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_symbol_list_gene_body_m4C.tsv"))
...
write_lines(gene_id_promoter_m5C, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_list_promoter_m5C.tsv"))
write_lines(gene_symbol_promoter_m5C, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_symbol_list_promoter_m5C.tsv"))
...
write_lines(gene_id_gene_body_m5C, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_list_gene_body_m5C.tsv"))
write_lines(gene_symbol_gene_body_m5C, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_symbol_list_gene_body_m5C.tsv"))
...
write_lines(gene_id_promoter_all_methyl, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_list_promoter_all_methyl.tsv"))
write_lines(gene_symbol_promoter_all_methyl, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_symbol_list_promoter_all_methyl.tsv"))

write_lines(gene_id_gene_body_all_methyl, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_list_gene_body_all_methyl.tsv"))
write_lines(gene_symbol_gene_body_all_methyl, glue("{out_dir}/{a_group}_{b_group}_{con}_gene_symbol_list_gene_body_all_methyl.tsv"))
