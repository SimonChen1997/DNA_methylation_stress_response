...
for condition in "37" "42" "ACE" "PA" "RE" "TNA"; do
    ...
    mkdir $modkit_dmr_phase_summary/exp_sta_${condition}

### if investigating the origin and valid dataset correlation, $dmr_phase_parallel=dmr_phase_gene_pvalue.R
### if the differentially methylated sites within datasets, $dmr_phase_parallel=dmr_phase_parallel.R
    ...
    Rscript $dmr_phase_parallel \
        ...
        -b "sta" \
        -c ${condition} \
        -o $modkit_dmr_phase_summary/exp_sta_${condition}
