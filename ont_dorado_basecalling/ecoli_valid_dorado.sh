#!/bin/bash -l
#SBATCH --job-name="ecoli_valid_dorado"
#SBATCH --partition=gpu_cuda
#SBATCH --gres=gpu:h100:1
#SBATCH -o ecoli_valid_dorado.o
#SBATCH -e ecoli_valid_dorado.e
...
$dorado basecaller --no-trim --recursive $model $input_scratch_pod5 --modified-bases 6mA 4mC_5mC \
    ...
    > $output_scratch_bam/ecoli_valid.bam

$dorado demux --output-dir $output_scratch_demultiplex \
    --kit-name SQK-NBD114-96 $output_scratch_bam/ecoli_valid.bam